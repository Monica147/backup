...
const Page5 = () => {
  const [feedbackData, setFeedbackData] = useState([
    { name: 'Paul', feedback: 'Good job!', trainer: 'Trainer 1', rating: 4, aptitudetariner: 'Trainer 2', aptitudefeedback: 'best', aptituderating: 5, domaintrainer: 'Trainer 3', domainfeedback: 'Too good', domainrating: 5, date: '2024-02-12' },
    { name: 'Jack', feedback: 'Well done!', trainer: 'Trainer 2', rating: 5, aptitudetariner: 'Trainer 3', aptitudefeedback: 'Great', aptituderating: 5, domaintrainer: 'Trainer 2', domainfeedback: 'Nice', domainrating: 5, date: '2024-02-10' },
    { name: 'Jill', feedback: 'Well done!', trainer: 'Trainer 2', rating: 3, aptitudetariner: 'Trainer 3', aptitudefeedback: 'Great', aptituderating: 5, domaintrainer: 'Trainer 2', domainfeedback: 'Nice', domainrating: 3, date: '2024-02-11' },
  ]);
