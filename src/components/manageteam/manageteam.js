          ...
          <div className='teammain container-fluid d-flex row'>
            <div className='teamdiv col-lg-8 col-md-12 p-2'>
              <div className='row g-3 col-lg-9'>
                <h2 className='text-black'>Track team activity</h2>
                <h6 className='pclass text-dark'>
              ...
              <div>
                <div className='d-flex row  row-cols-md-3 g-3 mt-2  mb-4   col-lg-9'>
                  <div className='col animate__animated animate__fadeInUp'>
                    <h5 className='text-dark'>Task Assignees</h5>
                  ...
                  <div className='col animate__animated animate__fadeInUp animate__delay-1s'>
                    <h5 className='text-dark'>Force Timer</h5>
      ...
      <h5 className="text-dark">Employee Scheduling</h5>
        <p className=" text-secondary">See who's available for work and give assignments.</p>
            ...
            <div className='justify-content-center align-self-center col-lg-4 col-md-12'>
              <img className='teamimg1 justify-content-center align-self-center animate__animated animate__fadeInLeft' src='https://img.freepik.com/free-vectorhand-drawn-business-planning-with-calendar_23-2149150730.jpg?w=996&t=st=1704943784~exp=1704944384~hmac=8b42094b819d0572b83b34a93a300fea7e09d7dab359b5f2d8393aaf7d3db6ff' alt='Calendar' />
              <img className='teamimg2 justify-content-center align-self-center animate__animated animate__fadeInRight' src='https://www.softwaresuggest.com/blog/wp-content/uploads/2020/02/The-Benefits-Of-Using-Time-Management-Software-768x307.png' alt='Time Management' />
            </div>
          </div>
        </div>
      )}
