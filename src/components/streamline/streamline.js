          ...
          <div className='streamMain container-fluid d-flex row'>
            <div className='streamdiv col-lg-8 col-md-12'>
              <div className='row g-3 col-lg-9'>
                <h2 className='streamtext animate__animated animate__fadeInUp'>Streamline Processes</h2>
                <h6 className='streamtext animate__animated animate__fadeInUp animate__delay-1s'>
            ...
            <div className='justify-content-center align-self-center col-lg-3 col-md-6'>
              <img className='streamimg1 animate__animated animate__fadeInRight' src='https://static.dashthis.com/media/1203/image_widgets.svg' alt='Streamline 1' />
              <img className='streamimg2 animate__animated animate__fadeInRight animate__delay-1s' src='https://invoice.ng/blog/wp-content/uploads/2022/06/Boost-business-growth-768x672.png' alt='Streamline 2' />
            </div>
          </div>
        </div>
      )}
